      ...
      <div>
        <table>
          ...
          <tr>
            ...
            <td>Optimal design of Silo for bulk storage of Rice</td>
            <td>Software</td>
          </tr>
          <tr>
            <td>562</td>
            ...
            <td>
              ...
              gentler on a new-born’s fragile skin and allow for more
          ...
          <tr>
            ...
            <td>
              ...
              communication/message to know its origin, date, time and spread{" "}
            </td>
            <td>Software</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>
              ...
              solution should be able to use inputs such as: PCR Call key words,
              Time of call, location, month, calendar of festivals/political
              events, community involved, distribution of similar PCR Calls,
              etc. to allow Command Room officers to icators of serious law &
              order issue at the very initial stages for timely intervention{" "}
            </td>
            <td>Software</td>
          </tr>
          <tr>
            ...
            <td>
              ...
              unattended child is a missing child from 'Track the missing child'
              database of WCD Ministry using Facial Recognition Software of
              Delhi Police "{" "}
            </td>
            <td>Software</td>
          </tr>
          ...
          <tr>
            ...
            <td>
              ...
              electronics devices, Camera etc. "
            </td>
            <td> </td>{" "}
          </tr>
        </table>
